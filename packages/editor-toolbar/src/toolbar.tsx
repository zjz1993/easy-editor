...
import type {IFileProps, IImageProps, IVideoProps, ExportProps} from '@textory/context';
...
export interface IToolbarProps {
  ...
  /** Optional. When undefined, VideoButton is not rendered (features.videoUpload=false). */
